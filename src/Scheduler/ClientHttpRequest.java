...
/********************************************************
 * Course Scheduler
 * File: ClientHttpRequest.java
 * 
 * Contains classes:
 * 	
 * 		ClientHttpRequest
 * 
 * 			Purpose: Sends POST HTTP requests with various
 * 				form data including files.
 * 
 * 		Author: Vlad Patryshev
 * 		Version: 1.0
 ********************************************************/
package Scheduler; // declare member of scheduler package


/*******************************************************************************
 * Declare imports: too many to list
 ******************************************************************************/
 ...
 * 
 * Purpose: Sends POST HTTP requests with various form data including files.
 * 
 * Author: Vlad Patryshev Version: 1.0
 ******************************************************************************/
...
public class ClientHttpRequest {
	 ...
	 **************************************************************************/
	protected final static long versionID = 2008043000002L;
