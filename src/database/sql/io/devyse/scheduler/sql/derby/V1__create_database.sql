...
create table version (
	id int not null generated by default as identity,
	retrieval_time varchar(255) default null,
...
create table date_time_block (
	...
	local_start_time varchar(255) default null,
	local_end_time varchar(255) default null,
	zone_offset varchar(255) default null,
...
create table term (
	...
	university_id int,
	name varchar(255) default null,
	term_identifier varchar(255) default null,
 ...
 */
create table term_data_set (
	id int not null generated by default as identity,
	term_id int,
	version_id int,
	constraint term_data_set_pkey primary key (id),
	constraint term_data_set_fkey_term_id foreign key (term_id) references term(id) on delete cascade,
	constraint term_data_set_fkey_version_id foreign key (version_id) references version(id) on delete cascade
);
...
create table section (
	...
	constraint section_fkey_term_data_set_id foreign key (term_data_set_id) references term_data_set(id) on delete cascade
);
...
create table instructor (
	...
	constraint instructor_fkey_term_data_set_id foreign key (term_data_set_id) references term_data_set(id) on delete cascade
);
