...
public class Parameters {
	...
	/**
	 * Provided for compatibility, this flag is often used by the .desktop files generated by linux systems
	 * when creating a .desktop file for a Java WebStart application.
	 * 
	 * Has no impact on application function at this point in time, strictly provided for compatibility so
	 * JCommander does not throw an exception when parsing the command line parameters.
	 * 
	 * Value: {@value}
	 */
	@Parameter(names = "-open", description = "Flag automatically used by many linux distros when generating " +
			"the .desktop file for a Java WebStart application. Provided for compatibility.")
	private boolean linuxDesktopOpen = false;
