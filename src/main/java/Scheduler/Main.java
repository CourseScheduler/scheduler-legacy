...
public class Main {
	...
	********************************************************/
	protected static final long versionID = 2015090400470L;//object id
	protected static final long buildNumber = 1621L;//build number
	protected static final String version = new String("4.12.10");
...
//				);
		...
		*/
		...
		Encryption.configureTlsClientProtocols(parameters.getTlsClientProtocols());
		Encryption.configureTlsLegacyAlgorithms(parameters.getTlsLegacyAlgorithms());
		Encryption.configureTlsDisabledAlgorithms(parameters.getTlsDisabledAlgorithms());
		Encryption.configureCertPathDisabledAlgorithms(parameters.getCertpathDisabledAlgorithms());
		Encryption.configureHttpsCipherSuites(parameters.getHttpsCipherSuites());
